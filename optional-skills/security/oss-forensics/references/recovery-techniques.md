...
## Method 1: Direct GitHub URL (Fastest Φ No Auth Required)
...
**When this fails**: GitHub has already garbage-collected the object (rare, typically 30Φ90 days post-force-push)
...
## Method 3: Git Fetch by SHA (Local Φ Requires Clone)
...
# Note: dangling objects only exist in LOCAL clone Φ not the same as GitHub's copies
...
### Via GitHub API (Limited Φ Only Non-Deleted Content)
...
### Via GitHub Archive (For Event History Φ Not Content)
