...
> **ΦΦ️ Research Use Only:** All metrics are experimental and derived from
...
Relative power values (sum Φ 1.0 across all bands):

| Band | Range (Hz) | High Means | Low Means |
|------|-----------|------------|-----------|
| **Delta (δ)** | 1Φ4 | Deep sleep (N3), high-amplitude artifacts | Awake, alert |
| **Theta (θ)** | 4Φ8 | Drowsiness, REM onset, creative ideation, cognitive load | Alert, focused |
| **Alpha (α)** | 8Φ13 | Relaxed wakefulness, "alpha blocking" during effort | Active thinking, anxiety |
| **Beta (β)** | 13Φ30 | Active concentration, problem-solving, alertness | Relaxed, unfocused |
| **Gamma (γ)** | 30Φ50 | Higher-order processing, perceptual binding, memory | Baseline |
...
## Core Composite Scores (0Φ1 Scale)

### Focus
- **Formula**: σ(β / (α + θ)) Φ beta dominance over slow waves, sigmoid-mapped
- **> 0.70**: Deep concentration, flow state, task absorption
- **0.40Φ0.69**: Moderate attention, some mind-wandering
- **< 0.40**: Distracted, fatigued, difficulty concentrating

### Relaxation
- **Formula**: σ(α / (β + θ)) Φ alpha dominance, sigmoid-mapped
- **> 0.70**: Calm, stress-free, parasympathetic dominant
- **0.40Φ0.69**: Mild tension present
- **< 0.30**: Stressed, anxious, sympathetic dominant

### Engagement
- **0Φ1 scale**: Active mental investment and motivation
- **> 0.70**: Mentally invested, motivated, active processing
- **0.40Φ0.69**: Passive participation
...
### Cognitive Load
- **Formula**: (P_θ_frontal / P_α_temporal) · f(FAA, TBR) Φ working memory usage
- **> 0.70**: Working memory near capacity, complex processing
- **0.40Φ0.69**: Moderate mental effort
...
|--------|---------|----------------|
| **FAA** | ln(P_α_AF8) Φ ln(P_α_AF7) | Frontal Alpha Asymmetry. Positive = approach/positive affect. Negative = withdrawal/depression. |
...
| **TBR** | P_θ / P_β | Theta/Beta Ratio. ADHD biomarker. Healthy Φ 1.0, elevated > 1.5, clinical > 3.0. |
| **APF** | argmax_f PSD(f) in [7.5, 12.5] Hz | Alpha Peak Frequency. Typical 8Φ12 Hz. Higher = faster cognitive processing. Slows with age/fatigue. |
| **SNR** | 10 · logΦΦ(P_signal / P_noise) | Signal-to-Noise Ratio. > 10 dB = clean, 3Φ10 dB = usable, < 3 dB = unreliable. |
| **Coherence** | Inter-hemispheric coherence (0Φ1) | Cortical connectivity between hemispheres. |
...
| **Higuchi Fractal Dimension (HFD)** | Waveform self-similarity. | Waking: 1.3Φ1.8; higher = complex |
| **DFA Exponent** | Long-range correlations. | Healthy: 0.6Φ0.9 |
...
|--------|-------|----------------|
| **LZC** | 0Φ100 | Lempel-Ziv Complexity proxy (PE + HFD). > 60 = wakefulness. |
| **Wakefulness** | 0Φ100 | Inverse drowsiness composite. |
| **Integration** | 0Φ100 | Cortical integration (Coherence × PAC × Spectral Entropy). |

Status thresholds: Φ 50 Green, 25Φ50 Yellow, < 25 Red.
...
|--------|-------------|---------------------|
| **HR** | Heart rate (bpm) | 55Φ90 (green), 45Φ110 (yellow), else red |
...
| **Stress Index** | Baevsky SI: AMo / (2 × MxDMn × Mo) | 0Φ100 composite. > 200 raw = strong stress |
| **SpOΦ Estimate** | Blood oxygen saturation (uncalibrated) | 95Φ100% normal (research only) |
| **Respiratory Rate** | Breaths per minute | 12Φ20 normal |
...
| Metric | Description |
|--------|-------------|
| **Stillness** | 0Φ1 (1 = perfectly still). From IMU accelerometer/gyroscope. |
| **Blink Count** | Eye blinks detected (large spikes in AF7/AF8). Normal: 15Φ20/min. |
...
|-----------|-------|----------------|
| **TP9** | 0Φ1 | Φ 0.9 = good, Φ 0.7 = acceptable, < 0.7 = poor |
| **AF7** | 0Φ1 | Same thresholds |
| **AF8** | 0Φ1 | Same thresholds |
| **TP10** | 0Φ1 | Same thresholds |
...
| N1 | 1 | Alpha Φ Theta transition | Light sleep onset |
...
|---------|-------------|----------------|
| **Flow State** | Focus > 0.75, Engagement > 0.70, Cognitive Load 0.50Φ0.70, HR steady | Optimal performance zone Φ protect it |
...
| **Creative Mode** | High Theta, high Alpha, low Beta, moderate focus | Ideation Φ don't force structure |
