...
> **ΦΦ️ Contraindication**: Wim Hof and hyperventilation-style breathwork are
...
| Flow State (focus > 0.75, engagement > 0.70) | **Do NOT interrupt Φ protect the session** |
...
**Instructions**:
1. Close your eyes
2. Breathe slowly Φ 4s inhale, 6s exhale
3. Count rhythmically from 1 to 10, matching your breath
4. Focus on the counting Φ if you lose count, restart from 1
5. Open your eyes after 4Φ5 full cycles
...
### Creativity Unlock
**Duration**: 5 minutes
**Trigger**: High beta, low rel_alpha Φ system is too analytically locked
**Instructions**:
1. Stop all structured work
2. Let your mind wander without a goal
3. Doodle, look out the window, or listen to ambient sound
4. Don't force any outcome Φ just observe what arises
...
### Physiological Sigh
**Duration**: 30 seconds (1Φ3 cycles)
...
**Duration**: 5 minutes
**Trigger**: High beta, low relaxation Φ cannot relax
**Instructions**:
1. Soften your gaze Φ don't focus on any single object
...
4. Repeat the visualization + left-hand squeeze 3Φ4 times
...
3. Do a 60-second body scan Φ notice where tension is held
...
4. Continue for 3Φ5 minutes while breathing slowly
...
**Instructions**:
1. Notice where anxiety lives in your body Φ chest? stomach? throat?
...
5. Continue observing for 5Φ8 minutes Φ anxiety typically peaks then subsides
...
2. Let yourself feel the scale Φ you are small, and that's beautiful
...
2. No agenda Φ just rest (don't force sleep)
...
4. If you fall asleep, that's fine Φ set an alarm
**Effect**: Restores dopamine and cognitive resources without sleep inertia

### Power Nap
**Duration**: 10Φ20 minutes (set alarm!)
...
**Effect**: Restores focus and alertness for 2Φ3 hours
...
5. Keep room cool (65Φ68°F / 18Φ20°C)
...
**Instructions**:
1. Start with feet Φ tense for 5 seconds, release for 8Φ10 seconds
2. Move upward: calves Φ thighs Φ abdomen Φ hands Φ arms Φ shoulders Φ face
3. Hold each tension 5 seconds, release 8Φ10 seconds
...
**Instructions**:
1. Ear-to-shoulder tilt Φ hold 15 seconds each side
2. Chin tucks Φ 10 reps (pull chin straight back)
3. Gentle neck circles Φ 5 each direction
4. Shoulder shrugs Φ 10 reps (squeeze up, release)
...
3. Brain-dump worries, tasks, ideas Φ anything occupying working memory
4. Close the document (review later if needed)
**Effect**: Externalizing working memory can reduce cognitive load by 20Φ40%
...
2. Don't act on it Φ just observe for 90 seconds
...
### Digital Sunset
**Duration**: 60Φ90 minutes before bed
**Trigger**: Evening, pre-sleep routine
**Instructions**:
1. Hard stop on all screens 60Φ90 minutes before bed
...
**Guidelines**:
- Consume caffeine 90Φ120 minutes after waking (cortisol has already peaked)
...
**Effect**: Mental contrasting improves follow-through by 2Φ3x
...
2. **Explain the metric connection** Φ why this protocol for this state
3. **Ask permission** Φ never start without the user's consent
4. **Announce each step** clearly with timing
5. **Check in after** Φ run `npx neuroskill status --json` to see if metrics improved
6. **Label the moment** Φ `npx neuroskill label "post-protocol: [name]"` for tracking

### Timing Guidelines for Step-by-Step Guidance
- Breath inhale: 3Φ5 seconds
- Breath hold: 2Φ4 seconds
- Breath exhale: 4Φ8 seconds
- Muscle tense: 5 seconds
- Muscle release: 8Φ10 seconds
- Body-scan region: 10Φ15 seconds
