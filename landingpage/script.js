// =========================================================================
// IO Landing Page Œ¶Äî Interactions
// =========================================================================
...
// --- Terminal Demo ---
const CURSOR = '<span class="terminal-cursor">Œ¶ñà</span>';

const demoSequence = [
  { type: "prompt", text: "Œ¶ùØ " },
  {
    type: "type",
  ...
  { type: "pause", ms: 500 },
  {
    ...
    lines: [
      ...
      "",
      '<span class="t-text">  <span class="t-green">Œ¶úì</span> GRPO\'s group-relative advantage (no critic model needed)</span>',
      '<span class="t-text">  <span class="t-green">Œ¶úì</span> Comparison with PPO/DPO on reasoning benchmarks</span>',
      '<span class="t-text">  <span class="t-green">Œ¶úì</span> Implementation notes for Axolotl and TRL</span>',
      "",
  ...
  {
    type: "type",
    text: "Review the PR at ever-oli/io#42 and fix any issues",
    delay: 30,
  },
  { type: "pause", ms: 600 },
  {
  ...
  { type: "pause", ms: 500 },
  {
    ...
    lines: [
      ...
      "",
      '<span class="t-text">  <span class="t-green">Œ¶úì</span> Empty tool schema crash in registry.py Œ¶Äî added guard</span>',
      '<span class="t-text">  <span class="t-green">Œ¶úì</span> Missing error handling in delegate_tool.py Œ¶Äî added try/except</span>',
      "",
  ...
  { type: "pause", ms: 500 },
  {
    ...
    lines: [
      "",
      '<span class="t-text">Found it Œ¶Äî from a session on February 12th:</span>',
      "",
...
// --- Noise Overlay (ported from io-chat NoiseOverlay) ---
