...
ALL io tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all io tools for a specific rollout.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("IO_QUIET")
        os.environ["IO_QUIET"] = "1"
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("IO_QUIET", None)
            else:
                os.environ["IO_QUIET"] = _prev_quiet
