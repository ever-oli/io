...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("io")
        class IOToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "io", "mistral", "llama3_json")
...
from environments.tool_call_parsers.io_parser import IOToolCallParser  # noqa: E402, F401
