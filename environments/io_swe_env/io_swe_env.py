"""
IOSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser io
    run-api
    python environments/io_swe_env.py serve \\
...
class IOSweEnv(IOAgentBaseEnv):
    ...
    name = "io-swe"
    env_config_cls = IOSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[IOSweEnvConfig, List[APIServerConfig]]:
        """
