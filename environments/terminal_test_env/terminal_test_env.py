...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from IO"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from IO",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from IO",
    },
    {
...
class TerminalTestEnv(IOAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/io/.env.
        """
