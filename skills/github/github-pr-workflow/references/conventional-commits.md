...
```
Closes #42          Φ closes the issue when merged
Fixes #42           Φ same effect
Refs #42            Φ references without closing
Co-authored-by: Name <email>
```

## Quick Decision Guide

- Added something new? Φ `feat`
- Something was broken and you fixed it? Φ `fix`
- Changed how code is organized but not what it does? Φ `refactor`
- Only touched tests? Φ `test`
- Only touched docs? Φ `docs`
- Updated CI/CD pipelines? Φ `ci`
- Updated dependencies or tooling? Φ `chore`
- Made something faster? Φ `perf`
