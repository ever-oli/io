...
# With curl Φ download and extract
...
4. Look for `ModuleNotFoundError` Φ usually a missing dependency in CI
...
CI Failed
ΦΦΦ Test failure
Φ   ΦΦΦ Assertion mismatch Φ update test or fix logic
Φ   ΦΦΦ Import/module error Φ add dependency
ΦΦΦ Lint failure Φ run formatter, fix style
ΦΦΦ Type error Φ fix types
ΦΦΦ Build failure
Φ   ΦΦΦ Missing dep Φ add to requirements
Φ   ΦΦΦ Version conflict Φ update pins
ΦΦΦ Permission error Φ update workflow permissions (needs user)
ΦΦΦ Timeout Φ investigate perf (may need user input)
```
