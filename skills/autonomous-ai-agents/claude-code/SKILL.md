...
metadata:
  io:
    ...
    related_skills: [codex, io]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the IO terminal. Claude Code is Anthropic's autonomous coding agent CLI.

## Prerequisites

- Claude Code installed: `npm install -g @anthropic-ai/claude-code`
- Authenticated: run `claude` once to log in
- Use `pty=true` in terminal calls Φ Claude Code is an interactive terminal app
...
1. **Always use `pty=true`** Φ Claude Code is an interactive terminal app and will hang without a PTY
