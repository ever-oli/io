...
/lambda/nfs/storage/
ΦΦΦ datasets/
Φ   ΦΦΦ raw/           # Original data
Φ   ΦΦΦ processed/     # Preprocessed data
ΦΦΦ models/
Φ   ΦΦΦ pretrained/    # Base models
Φ   ΦΦΦ fine-tuned/    # Your trained models
ΦΦΦ checkpoints/
Φ   ΦΦΦ experiment_1/  # Per-experiment checkpoints
ΦΦΦ logs/
Φ   ΦΦΦ tensorboard/   # Training logs
ΦΦΦ outputs/
    ΦΦΦ inference/     # Inference results
```
