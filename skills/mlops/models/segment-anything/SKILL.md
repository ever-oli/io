...
```
SAM Architecture:
ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ     ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ     ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ
Φ  Image Encoder  ΦΦΦΦΦΦΦ Prompt Encoder  ΦΦΦΦΦΦΦ  Mask Decoder   Φ
Φ     (ViT)       Φ     Φ (Points/Boxes)  Φ     Φ (Transformer)   Φ
ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ     ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ     ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ
        Φ                       Φ                       Φ
