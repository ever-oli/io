...
ΦΦΦ Model (neural networks)
Φ   ΦΦΦ UNet / Transformer (noise prediction)
Φ   ΦΦΦ VAE (latent encoding/decoding)
Φ   ΦΦΦ Text Encoder (CLIP/T5)
ΦΦΦ Scheduler (denoising algorithm)
```

### Pipeline inference flow

```
Text Prompt Φ Text Encoder Φ Text Embeddings
                                    Φ
Random Noise Φ [Denoising Loop] Φ Scheduler
                      Φ
               Predicted Noise
                      Φ
              VAE Decoder Φ Final Image
```
