...
```
grpo-rl-training/
ΦΦΦ SKILL.md                              # Main skill documentation (READ THIS FIRST)
ΦΦΦ README.md                             # This file
ΦΦΦ templates/
Φ   ΦΦΦ basic_grpo_training.py            # Production-ready training template
ΦΦΦ examples/
    ΦΦΦ reward_functions_library.py       # 20+ reward function examples
```
...
- Complete implementation workflow (dataset Φ rewards Φ training Φ deployment)
