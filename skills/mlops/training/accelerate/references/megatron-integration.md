...
**DP degree**:
- `DP = total_gpus / (TP × PP)`
- Example: 8 GPUs, TP=2, PP=2 Φ DP=2
...
- Example: DP=4 Φ 4× less optimizer memory per GPU
...
**Recommendations**:
- More micro-batches Φ less pipeline bubble
...
# Example: TP=4, 8K normal Φ 32K with sequence parallel
```
