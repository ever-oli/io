...
These are common mistakes Φ AgentResult does NOT have:
- `final_response` Φ extract from messages
- `tool_calls` Φ extract from messages  
- `tools_used` Φ extract from messages
- `output` Φ extract from messages
- `response` Φ extract from messages
