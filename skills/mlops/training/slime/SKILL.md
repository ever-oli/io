...
- You need enterprise-grade stability features Φ use **miles**
- You want flexible backend swapping Φ use **verl**
- You need PyTorch-native abstractions Φ use **torchforge**
...
Φ                    Data Buffer                          Φ
Φ - Prompt initialization and management                  Φ
Φ - Custom data generation and filtering                  Φ
Φ - Rollout sample storage                                Φ
ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ
              Φ                           Φ
ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ
Φ Training (Megatron-LM)  Φ Φ Rollout (SGLang + Router)   Φ
Φ - Actor model training  Φ Φ - Response generation       Φ
Φ - Critic (optional)     Φ Φ - Reward/verifier output    Φ
Φ - Weight sync to rolloutΦ Φ - Multi-turn support        Φ
ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ ΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦΦ
```
