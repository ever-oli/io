...
ΦΦΦ model/
Φ   ΦΦΦ __init__.py
Φ   ΦΦΦ args.py          # Model arguments
Φ   ΦΦΦ model.py         # Model definition
Φ   ΦΦΦ state_dict_adapter.py  # HF conversion (optional)
ΦΦΦ infra/
Φ   ΦΦΦ __init__.py
Φ   ΦΦΦ parallelize.py   # TP, FSDP, compile application
Φ   ΦΦΦ pipeline.py      # PP application (optional)
ΦΦΦ train_configs/
Φ   ΦΦΦ debug_model.toml
Φ   ΦΦΦ your_model_XB.toml
ΦΦΦ __init__.py          # TrainSpec registration
ΦΦΦ README.md
```
