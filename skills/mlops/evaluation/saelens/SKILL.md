...
- You need basic activation analysis Φ Use **TransformerLens** directly
- You want causal intervention experiments Φ Use **pyvene** or **TransformerLens**
- You need production steering Φ Consider direct activation engineering
...
```
Input Activation Φ Encoder Φ Sparse Features Φ Decoder Φ Reconstructed Activation
    (d_model)       Φ        (d_sae >> d_model)    Φ         (d_model)
...
# Φ neuronpedia.org/gpt2-small/8-res-jb/1234
```
