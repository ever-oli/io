...
```
Count pairs:
'e' + 's': 9 (newest: 6, widest: 3)  Φ most frequent
'l' + 'o': 7
'o' + 'w': 7
...
...
low: 5
lower: 2
newest: 6 Φ newes|t: 6
widest: 3 Φ wides|t: 3
...
low: 5
lower: 2
newest: 6 Φ new|est: 6
widest: 3 Φ wid|est: 3
...
- Merge 'l' + 'o' Φ 'lo' (if this merge was learned)
- Merge 'lo' + 'w' Φ 'low' (if learned)
- Merge 'e' + 's' Φ 'es' (learned)
- Merge 'es' + 't' Φ 'est' (learned)
...
- "aa" appears 100 times Φ high priority
- Even if 'a' appears 1000 times alone

**WordPiece**: Merges pairs that are semantically related
- "aa" appears 100 times, 'a' appears 1000 times Φ low score (100 / (1000 × 1000))
- "th" appears 50 times, 't' appears 60 times, 'h' appears 55 times Φ high score (50 / (60 × 55))
...
score('es' + 't') = 9 / (9 × 9) = 0.111  Φ highest score
score('l' + 'o') = 7 / (7 × 9) = 0.111   Φ tied

Choose: 'es' + 't' Φ 'est' (or 'lo' if tied)
```
...
print(output.tokens)  # ['ΦToken', 'ization', 'Φwith', 'ΦUn', 'igram']
```
...
Φ ['anti', 'dis', 'establish', 'ment', 'arian', 'ism']
```
...
```
"antidisestablishmentarianism"
Φ ['Φanti', 'dis', 'establish', 'ment', 'arian', 'ism']
```
...
"Hello WORLD" Φ "hello world" Φ ['hello', 'world']
```
...
"Hello 🌍 👋" Φ byte-level representation (always works)
```
...
"é" (composed) Φ "é" (decomposed) Φ normalized to one form
```
...
**Symptom**:
```
"running" Φ ['r', 'u', 'n', 'n', 'i', 'n', 'g']  (too granular)
```
