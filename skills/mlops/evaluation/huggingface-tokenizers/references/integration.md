...
| Alignment tracking       | Φ Full support | Φ Limited     |
| Batch processing         | Φ Optimized    | ΦΦ️ Slower      |
| Offset mapping           | Φ Yes          | Φ No          |
...
for token, (start, end) in zip(
    ...
    print(f"{token:10s} Φ [{start:2d}, {end:2d})")
...
# my-model/
#   ΦΦΦ config.json
#   ΦΦΦ pytorch_model.bin
#   ΦΦΦ tokenizer.json
#   ΦΦΦ tokenizer_config.json
#   ΦΦΦ special_tokens_map.json
