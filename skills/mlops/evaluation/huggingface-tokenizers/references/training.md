...
**Decision tree**:
- **GPT-style model** Φ BPE
- **BERT-style model** Φ WordPiece
- **Multilingual/No word boundaries** Φ Unigram
...
for phrase in test_phrases:
    ...
    print(f"{phrase:25s} Φ {tokens}")

# Good tokenization:
# tokenization              Φ ['token', 'ization']
# machine learning          Φ ['machine', 'learning']
# artificial intelligence   Φ ['artificial', 'intelligence']
```
