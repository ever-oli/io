...
```python
# Φ Good: Enum ensures valid values
...
|---------|------------|-------------|-----------|------|
| Type Safety | Φ Yes | Φ No | ΦΦ️ Partial | Φ Yes |
| Auto Validation | Φ Yes | Φ No | Φ No | ΦΦ️ Limited |
| Auto Retry | Φ Yes | Φ No | Φ No | Φ Yes |
| Streaming | Φ Yes | Φ No | Φ Yes | Φ No |
| Multi-Provider | Φ Yes | ΦΦ️ Manual | Φ Yes | Φ Yes |
