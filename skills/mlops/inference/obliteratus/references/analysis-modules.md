# OBLITERATUS Analysis Modules Φ Reference
...
Post-excision verification Φ probes for residual refusal concepts after
...
Interchange interventions Φ swaps activations between refused and complied
...
Linear Erasure via Closed-form Estimation Φ mathematically optimal linear
...
# quick     Φ Fast sanity check (2-3 modules)
# full      Φ All core + geometric analysis
# jailbreak Φ Refusal circuit localization
# knowledge Φ Knowledge preservation analysis
# robustness Φ Stress testing / defense evaluation
```
