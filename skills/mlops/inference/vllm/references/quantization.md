...
|--------------|----------|--------|-------|------------------|
| FP16 (baseline) | 100% | 140GB | 1.0x | Φ (if memory available) |
| FP8 | 99.5% | 70GB | 1.8x | Φ (H100 only) |
| AWQ 4-bit | 99.0% | 35GB | 1.5x | Φ (best for 70B) |
| GPTQ 4-bit | 98.5% | 35GB | 1.5x | Φ (good compatibility) |
| SqueezeLLM 3-bit | 96.0% | 26GB | 1.3x | ΦΦ️ (check accuracy) |
...
# Decision
if degradation < 1.0:
    print("Φ Quantization acceptable for production")
else:
    print("ΦΦ️ Review accuracy loss")
```
