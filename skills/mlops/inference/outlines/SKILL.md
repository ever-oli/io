...
# Φ Good: With constraints
class User(BaseModel):
    name: str = Field(min_length=1, max_length=100)
    age: int = Field(ge=0, le=120)
    email: str = Field(pattern=r"^[\w\.-]+@[\w\.-]+\.\w+$")

# Φ Bad: No constraints
class User(BaseModel):
    name: str
    age: int
    email: str
...
# Φ Good: Optional fields for incomplete data
class Article(BaseModel):
    title: str  # Required
...
|---------|----------|------------|----------|------|
| Pydantic Support | Φ Native | Φ Native | Φ No | Φ No |
| JSON Schema | Φ Yes | Φ Yes | ΦΦ️ Limited | Φ Yes |
| Regex Constraints | Φ Yes | Φ No | Φ Yes | Φ Yes |
| Local Models | Φ Full | ΦΦ️ Limited | Φ Full | Φ Full |
| API Models | ΦΦ️ Limited | Φ Full | Φ Full | Φ Full |
| Zero Overhead | Φ Yes | Φ No | ΦΦ️ Partial | Φ Yes |
| Automatic Retrying | Φ No | Φ Yes | Φ No | Φ No |
