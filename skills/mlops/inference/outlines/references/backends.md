...
|---------|-------------|-----------|------|--------|
| Structured Generation | Φ Full | Φ Full | Φ Full | ΦΦ️ Limited |
| FSM Optimization | Φ Yes | Φ Yes | Φ Yes | Φ No |
| GPU Support | Φ Yes | Φ Yes | Φ Yes | N/A |
| Multi-GPU | Φ Yes | Φ Yes | Φ Yes | N/A |
| Quantization | Φ Yes | Φ Yes | Φ Yes | N/A |
| High Throughput | ΦΦ️ Medium | ΦΦ️ Medium | Φ Excellent | ΦΦ️ API-limited |
