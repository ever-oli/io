...
|------|--------------|--------------|
| `paragraph` | `.paragraph.rich_text` | Φ |
| `heading_1/2/3` | `.heading_N.rich_text` | Φ |
| `bulleted_list_item` | `.bulleted_list_item.rich_text` | Φ |
| `numbered_list_item` | `.numbered_list_item.rich_text` | Φ |
| `to_do` | `.to_do.rich_text` | `.to_do.checked` (bool) |
| `toggle` | `.toggle.rich_text` | has children |
| `code` | `.code.rich_text` | `.code.language` |
| `quote` | `.quote.rich_text` | Φ |
...
| `child_page` | Φ | `.child_page.title` |
| `child_database` | Φ | `.child_database.title` |

Rich text arrays contain objects with `.plain_text` Φ concatenate them for readable output.
