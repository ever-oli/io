...
- Screen Recording permission for terminal (System Settings Φ Privacy Φ Screen Recording)
...
# 2. Click on the AirTag item (stay on page Φ AirTag only updates when page is open)
...
- FindMy has **no CLI or API** Φ must use UI automation
...
2. Use `vision_analyze` to read screenshot content Φ don't try to parse pixels
3. For ongoing tracking, use a cronjob to periodically capture and log locations
4. Respect privacy Φ only track devices/items the user owns
