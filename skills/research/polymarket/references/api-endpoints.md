...
## Gamma API Φ gamma-api.polymarket.com
...
Parameters:
- `limit` Φ max results (default varies)
- `offset` Φ pagination offset
- `active` Φ true/false
- `closed` Φ true/false
- `order` Φ sort field: `volume`, `createdAt`, `updatedAt`
- `ascending` Φ true/false
- `tag` Φ filter by tag slug
- `slug` Φ get specific event by slug
...
- `slug` Φ get specific market by slug
...
## CLOB API Φ clob.polymarket.com
...
Parameters:
- `market` Φ the conditionId (hex string with 0x prefix)
- `interval` Φ time range: `all`, `1d`, `1w`, `1m`, `3m`, `6m`, `1y`
- `fidelity` Φ number of data points to return
...
## Data API Φ data-api.polymarket.com
