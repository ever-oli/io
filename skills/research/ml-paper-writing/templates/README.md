...
2. Install VS Code extension: **LaTeX Workshop** by James Yu
   - Open VS Code Φ Extensions (Cmd/Ctrl+Shift+X) Φ Search "LaTeX Workshop" Φ Install

**Usage:**
- Open any `.tex` file in VS Code
- Save the file (Cmd/Ctrl+S) Φ Auto-compiles to PDF
...
```json
{
  ...
  "latex-workshop.latex.recipes": [
    {
      "name": "pdflatex Φ bibtex Φ pdflatex × 2",
...
2. New Project Φ Upload Project Φ Upload the template folder as ZIP
