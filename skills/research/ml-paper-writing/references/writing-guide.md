...
**The "What"**: One to three specific novel claims fitting within a cohesive theme. Vague contributions like "we study X" fail immediatelyΦreviewers need precise, falsifiable claims.
...
This applies whether you're presenting a new architecture, a theoretical result, or improved understanding of existing methodsΦNeurIPS explicitly notes that "originality does not necessarily require an entirely new method."

**Practical Implication**: If you cannot state your contribution in one sentence, you don't yet have a paper. Everything elseΦexperiments, related work, discussionΦexists only to support that core claim.
...
This isn't hyperboleΦmost reviewers form preliminary judgments before reaching your methods section. Readers encounter your paper in a predictable pattern: **title Φ abstract Φ introduction Φ figures Φ maybe the rest.**
...
The beginning of a sentence establishes perspective. Put the "whose story" element firstΦreaders expect the sentence to be about whoever shows up first.
...
Provide context before asking the reader to consider anything new. This applies at all levelsΦsentence, paragraph, section.
...
| Old Before New | Familiar Φ unfamiliar | "Build on known ground" |
...
**Original**: "X's Y" Φ **Unfolded**: "The Y of X"
...
5. **Expand contractions** - "don't" Φ "do not" for formality
...
Example: "the model's accuracy" Φ "the accuracy of the model"
...
| Missing relevant citations | Reviewers authored papersΦcite generously |
