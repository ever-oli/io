...
**Never generate citations from memoryΦalways verify programmatically.**
...
```
Need ML paper search? Φ Semantic Scholar
Have DOI, need BibTeX? Φ CrossRef content negotiation
Looking for preprint? Φ arXiv API
Need open data, bulk access? Φ OpenAlex
```
...
```
1. SEARCH Φ Query Semantic Scholar with specific keywords
     Φ
2. VERIFY Φ Confirm paper exists in 2+ sources
     Φ
3. RETRIEVE Φ Get BibTeX via DOI content negotiation
     Φ
4. VALIDATE Φ Confirm the claim appears in source
     Φ
5. ADD Φ Add verified entry to .bib file
```
