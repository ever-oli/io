...
Φ Start with: Neel Nanda, Sebastian Farquhar, Andrej Karpathy

### For Sentence-Level Clarity
Φ Start with: Gopen & Swan, Ethan Perez, Zachary Lipton

### For Word Choice & Style
Φ Start with: Zachary Lipton, Jacob Steinhardt

### For Conference-Specific Requirements
Φ Start with: Official venue guidelines (NeurIPS, ICML, ICLR, ACL)

### For Citation Management
Φ Start with: Semantic Scholar API, CrossRef, citation-workflow.md

### For Reviewer Expectations
Φ Start with: Venue reviewer guidelines, reviewer-guidelines.md
