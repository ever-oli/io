...
**Never skip because:**
- "It's simple" Φ simple bugs compound
- "I'm in a hurry" Φ reviews save time
- "I tested it" Φ you have blind spots
...
delegate_task(
    ...
    - Critical Issues: [must fix Φ blocks merge]
...
Review after EACH task Φ this is the two-stage review:
