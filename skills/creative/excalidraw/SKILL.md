...
- Emit progressively: background zones Φ shape Φ its bound text Φ its arrows Φ next shape
- BAD: all rectangles, then all texts, then all arrows
- GOOD: bg_zone Φ shape1 Φ text_for_shape1 Φ arrow1 Φ arrow_label_text Φ shape2 Φ text_for_shape2 Φ ...
