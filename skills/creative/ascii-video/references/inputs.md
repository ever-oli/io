...
| `bdecay` | Exponential decay from beats | Smooth beat pulse (0Φ1Φ0) |

**Band ratios are critical** Φ they decouple spectral shape from volume, so a quiet bass section and a loud bass section both read as "bassy" rather than just "loud" vs "quiet".
...
`bdecay` gives smooth 0Φ1Φ0 pulse per beat, decaying over ~0.5s. Use for flash/glitch/mirror triggers.
