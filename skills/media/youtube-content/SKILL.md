...
This skill includes `fetch_transcript.py` Φ use it to fetch transcripts quickly:
...
- **Thread**: Twitter/X thread format Φ numbered posts, each under 280 chars
...
- **Transcript disabled**: Some videos have transcripts turned off Φ tell the user
- **Private/unavailable**: The API will raise an error Φ relay it clearly
