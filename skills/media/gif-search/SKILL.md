...
Set your Tenor API key in your environment (add to `~/.io/.env`):

```bash
TENOR_API_KEY=your_key_here
```

Get a free API key at https://developers.google.com/tenor/guides/quickstart Φ the Google Cloud Console Tenor API key is free and has generous rate limits.
