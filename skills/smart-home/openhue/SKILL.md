...
- Bridge must be on the same local network as the machine running IO
...
- Light and room names are case-sensitive Φ use `openhue get light` to check exact names
