...
- WHOIS lookup Φ supports 100+ TLDs via direct TCP queries
...
- crt.sh Φ Certificate Transparency logs
- WHOIS servers Φ Direct TCP to 100+ authoritative TLD servers  
- Google DNS-over-HTTPS Φ MX/NS/TXT/CNAME resolution
- System DNS Φ A/AAAA records
