...
- **Server name / MOTD** Φ what should it say in the server list?
- **Seed** Φ specific seed or random?
- **Difficulty** Φ peaceful / easy / normal / hard?
- **Gamemode** Φ survival / creative / adventure?
- **Online mode** Φ true (Mojang auth, legit accounts) or false (LAN/cracked friendly)?
- **Player count** Φ how many players expected? (affects RAM & view distance tuning)
- **RAM allocation** Φ or let agent decide based on mod count & available RAM?
- **View distance / simulation distance** Φ or let agent pick based on player count & hardware?
- **PvP** Φ on or off?
- **Whitelist** Φ open server or whitelist only?
- **Backups** Φ want automated backups? How often?
...
### 2. Install Java
- Minecraft 1.21+ Φ Java 21: `sudo apt install openjdk-21-jre-headless`
- Minecraft 1.18-1.20 Φ Java 17: `sudo apt install openjdk-17-jre-headless`
- Minecraft 1.16 and below Φ Java 8: `sudo apt install openjdk-8-jre-headless`
- Verify: `java -version`
...
## Pitfalls
- ALWAYS set `allow-flight=true` for modded Φ mods with jetpacks/flight will kick players otherwise
- `max-tick-time=180000` or higher Φ modded servers often have long ticks during worldgen
- First startup is SLOW (several minutes for big packs) Φ don't panic
...
- The pack's startserver.sh often has an auto-restart loop Φ make a clean launch script without it
