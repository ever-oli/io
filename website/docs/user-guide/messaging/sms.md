...
sidebar_position: 8
title: "SMS (Twilio)"
description: "Set up IO as an SMS chatbot via Twilio"
---

# SMS Setup (Twilio)

IO connects to SMS through the [Twilio](https://www.twilio.com/) API. People text your Twilio phone number and get AI responses back Φ same conversational experience as Telegram or Discord, but over standard text messages.
...
- **Twilio account** Φ [Sign up at twilio.com](https://www.twilio.com/try-twilio) (free trial available)
- **A Twilio phone number** with SMS capability
- **A publicly accessible server** Φ Twilio sends webhooks to your server when SMS arrives
- **aiohttp** Φ `pip install 'io[sms]'`
...
3. Go to **Phone Numbers Φ Manage Φ Active Numbers** Φ note your phone number in E.164 format (e.g., `+15551234567`)
...
1. Go to **Phone Numbers Φ Manage Φ Active Numbers**
2. Click your phone number
3. Under **Messaging Φ A MESSAGE COMES IN**, set:
   - **Webhook**: `https://your-server:8080/webhooks/twilio`
   - **HTTP Method**: `POST`

:::tip Exposing Your Webhook
If you're running IO locally, use a tunnel to expose the webhook:
...
Text your Twilio number Φ IO will respond via SMS.
...
- **Plain text only** Φ Markdown is automatically stripped since SMS renders it as literal characters
- **1600 character limit** Φ Longer responses are split across multiple messages at natural boundaries (newlines, then spaces)
- **Echo prevention** Φ Messages from your own Twilio number are ignored to prevent loops
- **Phone number redaction** Φ Phone numbers are redacted in logs for privacy
...
3. Check the Twilio Console Φ **Monitor Φ Logs Φ Messaging** for delivery errors
...
3. Check IO gateway logs for Twilio API errors
