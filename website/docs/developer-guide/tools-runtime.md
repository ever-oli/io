...
IO tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. IO resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`io-cli`, `io-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `io-acp`
