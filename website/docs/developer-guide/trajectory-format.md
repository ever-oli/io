...
description: "How IO saves trajectories, normalizes tool calls, and produces training-friendly outputs"
---

# Trajectories & Training Format

IO can save conversation trajectories for training, evaluation, and batch data generation workflows.
...
IO converts live conversation structure into a training-friendly format.
