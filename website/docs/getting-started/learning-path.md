...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the IO documentation based on your experience level and goals.'
---

# Learning Path

IO can do a lot Φ CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed IO yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything IO can do.

## By Experience Level

| Level | Goal | Recommended Reading | Time Estimate |
|---|---|---|---|
| **Beginner** | Get up and running, have basic conversations, use built-in tools | [Installation](/docs/getting-started/installation) Φ [Quickstart](/docs/getting-started/quickstart) Φ [CLI Usage](/docs/user-guide/cli) Φ [Configuration](/docs/user-guide/configuration) | ~1 hour |
| **Intermediate** | Set up messaging bots, use advanced features like memory, cron jobs, and skills | [Sessions](/docs/user-guide/sessions) Φ [Messaging](/docs/user-guide/messaging) Φ [Tools](/docs/user-guide/features/tools) Φ [Skills](/docs/user-guide/features/skills) Φ [Memory](/docs/user-guide/features/memory) Φ [Cron](/docs/user-guide/features/cron) | ~2Φ3 hours |
| **Advanced** | Build custom tools, create skills, train models with RL, contribute to the project | [Architecture](/docs/developer-guide/architecture) Φ [Adding Tools](/docs/developer-guide/adding-tools) Φ [Creating Skills](/docs/developer-guide/creating-skills) Φ [RL Training](/docs/user-guide/features/rl-training) Φ [Contributing](/docs/developer-guide/contributing) | ~4Φ6 hours |
...
Use IO as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. IO can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy IO as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with IO](/docs/guides/use-voice-mode-with-io)
...
:::tip
Cron jobs let IO run tasks on a schedule Φ daily summaries, periodic checks, automated reports Φ without you being present.
:::

### "I want to build custom tools/skills"

Extend IO with your own tools and reusable skill packages.
...
Use reinforcement learning to fine-tune model behavior with IO's built-in RL training pipeline.
...
:::tip
RL training works best when you already understand the basics of how IO handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate IO into your own Python applications programmatically.
...
- **Just finished installing?** Φ Head to the [Quickstart](/docs/getting-started/quickstart) to run your first conversation.
- **Completed the Quickstart?** Φ Read [CLI Usage](/docs/user-guide/cli) and [Configuration](/docs/user-guide/configuration) to customize your setup.
- **Comfortable with the basics?** Φ Explore [Tools](/docs/user-guide/features/tools), [Skills](/docs/user-guide/features/skills), and [Memory](/docs/user-guide/features/memory) to unlock the full power of the agent.
- **Setting up for a team?** Φ Read [Security](/docs/user-guide/security) and [Sessions](/docs/user-guide/sessions) to understand access control and conversation management.
- **Ready to build?** Φ Jump into the [Developer Guide](/docs/developer-guide/architecture) to understand the internals and start contributing.
- **Want practical examples?** Φ Check out the [Guides](/docs/guides/tips) section for real-world projects and tips.
