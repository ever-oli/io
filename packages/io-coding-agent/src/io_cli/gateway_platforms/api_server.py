...
- GET  /v1/models                  — lists io-agent as an available model
- GET  /health                     — health check

Any OpenAI-compatible frontend (Open WebUI, LobeChat, LibreChat,
AnythingLLM, NextChat, ChatBox, etc.) can connect to io-agent
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    and routes them through io-agent's AIAgent.
    """
    ...
    def _create_agent(
        ...
        max_iterations = int(os.getenv("IO_MAX_ITERATIONS", "90"))
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"status": "ok", "platform": "io-agent"})

    async def _handle_models(self, request: "web.Request") -> "web.Response":
        """GET /v1/models — return io-agent as an available model."""
    ...
    async def _handle_chat_completions(self, request: "web.Request") -> "web.Response":
        ...
        model_name = body.get("model", "io-agent")
        created = int(time.time())
