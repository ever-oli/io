...
"""
Email platform adapter for the IO gateway.

Allows users to interact with IO by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "IO Agent")
        ...
        msg_id = f"<io-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
