...
class WhatsAppAdapter(BasePlatformAdapter):
    ...
    # Default bridge location relative to the io-agent install
        ...
        try:
            ...
            if data.get("status") != "connected":
                ...
                for attempt in range(15):
                    ...
                    print(f"[{self.name}]   If session expired, re-pair: io gateway setup --platform whatsapp")
