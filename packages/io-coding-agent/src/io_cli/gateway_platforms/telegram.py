...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("IO_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
        ...
        self._text_batch_delay_seconds = float(os.getenv("IO_TELEGRAM_TEXT_BATCH_DELAY_SECONDS", "0.6"))
    ...
    def _parse_polled_message(self, message: dict[str, Any]) -> MessageEvent | None:
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "IO stopped Telegram polling to avoid endless retry spam. "
    ...
    async def connect(self) -> bool:
        ...
        try:
            from ..gateway_runtime import acquire_scoped_lock
            ...
            if not acquired:
                ...
                message = (
                    "Another local IO gateway is already using this Telegram bot token"
            ...
            if self._token_lock_identity:
                try:
                    from ..gateway_runtime import release_scoped_lock
        ...
        if not self._bot and self.token:
            try:
                ...
                for chunk in chunks:
                    ...
                    response = await self._request_json("sendMessage", payload=payload)
                ...
                logger.error("[%s] Failed to send Telegram message via Bot API: %s", self.name, e, exc_info=True)
    ...
    def _text_batch_key(self, event: MessageEvent) -> str:
        ...
        from ..gateway_session import build_session_key
