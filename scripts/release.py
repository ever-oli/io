...
VERSION_FILE = REPO_ROOT / "io_cli" / "__init__.py"
PYPROJECT_FILE = REPO_ROOT / "pyproject.toml"

# Œ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄ
# Git email Œ¶Üí GitHub username mapping
# Œ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄŒ¶îÄ
...
AUTHOR_MAP = {
    ...
    "io@nousresearch.com": "NousResearch",
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/ever-oli/io",
    ...
    lines.append(f"# IO v{semver} ({tag_name})")
    lines.append("")
    lines.append(f"**Release Date:** {date_str}")
    lines.append("")

    if first_release:
        lines.append("> üéâ **First official release!** This marks the beginning of regular weekly releases")
        lines.append("> for IO. See below for everything included in this initial release.")
        lines.append("")
    ...
    category_order = [
        ("breaking", "Œ¶Œ¶†Ô∏è Breaking Changes"),
        ("features", "Œ¶ú® Features"),
        ("improvements", "üîß Improvements"),
        ("fixes", "üêõ Bug Fixes"),
        ("docs", "üìŒ¶ Documentation"),
        ("tests", "üß™ Tests"),
        ("chore", "üèóÔ∏è Infrastructure"),
...
def main():
    parser = argparse.ArgumentParser(description="IO Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  IO Release Preview")
    print(f"{'='*60}")
    print(f"  CalVer tag:      {tag_name}")
    print(f"  SemVer:          v{current_version} Œ¶Üí v{new_version}")
    print(f"  Previous tag:    {prev_tag or '(none Œ¶Äî first release)'}")
    ...
    if args.publish:
        ...
        if args.bump:
            ...
            print(f"  Œ¶úì Updated version files to v{new_version} ({calver_date})")

            # Commit version bump
            git("add", str(VERSION_FILE), str(PYPROJECT_FILE))
            git("commit", "-m", f"chore: bump version to v{new_version} ({calver_date})")
            print(f"  Œ¶úì Committed version bump")

        # Create annotated tag
        git("tag", "-a", tag_name, "-m",
            f"IO v{new_version} ({calver_date})\n\nWeekly release")
        print(f"  Œ¶úì Created tag {tag_name}")

        # Push
        push_result = git("push", "origin", "HEAD", "--tags")
        print(f"  Œ¶úì Pushed to origin")
        ...
        result = subprocess.run(
            ["gh", "release", "create", tag_name,
             "--title", f"IO v{new_version} ({calver_date})",
        ...
        if result.returncode == 0:
            print(f"  Œ¶úì GitHub release created: {result.stdout.strip()}")
        else:
            print(f"  Œ¶úó GitHub release failed: {result.stderr}")
            print(f"    Tag was created. Create the release manually:")
            print(f"    gh release create {tag_name} --title 'IO v{new_version} ({calver_date})'")

        print(f"\n  üéâ Release v{new_version} ({tag_name}) published!")
    else:
        print(f"\n{'='*60}")
